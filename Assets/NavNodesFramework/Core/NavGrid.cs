...
namespace NavNodesFramework.Core
{
	...
	{
		[Header("-- Node Layer Settings --")]
		[SerializeField, Tooltip("The layers that the nodes are allowed to be generated on top of")] 
		private LayerMask allowedNodeLayers;
		public LayerMask AllowedNodeLayers => allowedNodeLayers;
		[SerializeField, Tooltip("Nodes that are near GameObjects with this tag will be marked as blocked")] 
		private LayerMask pathBlockingLayers;
		public LayerMask PathBlockingLayers => pathBlockingLayers;
		[Header("-- Node Ray Check Settings --")]
		[SerializeField, Tooltip("The height to raycast down from to generate nodes")] 
		private float nodeCheckHeight = 2;
		public float NodeCheckHeight => nodeCheckHeight;
		[SerializeField, Tooltip("the distance the raycast used for detecting floor will go")] 
		private float nodeCheckRayDistance = 100;
		public float NodeCheckRayDistance => nodeCheckRayDistance;
		[Header("-- General Settings --")]
		[SerializeField, Tooltip("The maximum number of nodes that will be generated")] 
		private int maxNodes = 2048;
		[SerializeField, Tooltip("how far apart the grid nodes are from each other")] 
		private float gridSize = 1;
		public float GridSize => gridSize;
		[SerializeField, Tooltip("The node prefab")] 
		...
		[SerializeField, Tooltip("Turn this off before entering play mode")] 
		private bool showNodesInEditMode;
